  ...
  async generateStockAlertsPDF(
    ...
    return new Promise((resolve) => {
      ...
      doc
        ...
        .font('Helvetica')
        .fillColor('#666666')
        .text('Productos con stock por debajo del mínimo (10 unidades)', {
          align: 'center',
        });
      ...
      // Table header
      doc.fontSize(12).font('Helvetica-Bold').text('PRODUCTOS CON STOCK BAJO');
      ...
      headers.forEach((header, i) => {
        doc
          ...
          .fill()
          .fillColor('#000000')
          .text(header, tableLeft + i * colWidth + 2, tableTop + 5, {
            width: colWidth - 4,
          });
      });
      ...
      alerts.forEach((alert, index) => {
        ...
        const rowData = [
          ...
          alert.codigo,
          alert.descripcion.length > 15
            ? alert.descripcion.substring(0, 15) + '...'
            : alert.descripcion,
        ...
        rowData.forEach((cell, i) => {
          doc
            ...
            .font('Helvetica')
            .fillColor('#000000')
            .text(cell, tableLeft + i * colWidth + 2, y + 5, {
              width: colWidth - 4,
            });
        });
      });
    ...
    return new Promise((resolve) => {
      ...
      data.forEach((item, index) => {
        ...
        const rowData = [
          item.fecha,
          item.codigoProducto,
          item.descripcion.length > 12
            ? item.descripcion.substring(0, 12) + '...'
            : item.descripcion,
